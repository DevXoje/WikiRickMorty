...
module.exports = __webpack_require__(/*! C:\Users\34622\Desktop\Wiki\src\main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'userslist',
        loadChildren: () => __webpack_require__.e(/*! import() | userslist-userslist-module */ "userslist-userslist-module").then(__webpack_require__.bind(null, /*! ./userslist/userslist.module */ "plwT")).then(m => m.UserslistPageModule)
    },
    {
        path: 'profile/:id',
